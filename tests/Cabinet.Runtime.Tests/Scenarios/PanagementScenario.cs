...
public sealed class PanagementScenario(PanagementScenario.Installed installed)
    : IClassFixture<PanagementScenario.Installed>
{
    private const string Id = "panagement";

    private const string Mix = "Global Amount";

    private static readonly Dictionary<string, string> Bridges = new()
    {
        ["VST3"] = "Auburn Sounds Panagement 2.vst3",
        ["LV2"] = "https://www.auburnsounds.com/products/Panagement.html40733232#stereo",
    };
    ...
    public async Task OpensItsEditorAndPans(string format)
    {
        Assert.True(
