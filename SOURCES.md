...
The Klevgrand Helper's `klevgrand-helper-runtime.zip` contains the MSYS2 MinGW libarchive 3.8.9-5
runtime and its pinned dependencies. Its package hashes, source links, relinking details and licence
notices are in `data/library/klevgrand/klevgrand-helper-runtime.txt`; the archive SHA-256 is
...
| native-access | Native Instruments' Native Access product page, `native-instruments.com/cdn/shop/files/Native-Access-2-product-page-03_REBRAND.png` — its library view; its icon is the official Native Instruments signet below, not a crop of the screenshot |
| klevgrand-helper | Klevgrand's official Helper guide, `cdn.klevgrand.com/assets/ui_images/helper.png` — the app's own interface; its icon is Klevgrand's official 192px app mark at `klevgrand.com/android-icon-192x192.png`, not a crop of the screenshot |
...
| native-instruments | Native Instruments' official signet, `native-instruments.com/cdn/shop/files/Native-Instruments-signet.svg`, recoloured ivory; its Native Access icon uses the same signet |
| klevgrand | Klevgrand's official 192px app mark, `klevgrand.com/android-icon-192x192.png` |
